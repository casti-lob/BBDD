...
CREATE TABLE PRODUCTO
	...
	CONSTRAINT fk_producto_fabricante FOREIGN KEY(codigo_fabricante) REFERENCES FABRICANTE(codigo)ON UPDATE CASCADE
	);
...
ALTER TABLE PRODUCTO ADD CONSTRAINT fk_producto_fabricante FOREIGN KEY(codigo_fabricante) REFERENCES FABRICANTE(codigo) ON DELETE CASCADE;
